...
const Snackbar: ForwardRefRenderFunction<ISnackbarHandles, MessageProps> = (
  props,
  ref
) => {
  ...
  if (!snackbarConfig.isVisible) return <></>
  ...
  return (
    ...
    >
      <div className='snackbar-content'>
        ...
        <div className='snackbar-message'>{snackbarConfig.message}</div>
